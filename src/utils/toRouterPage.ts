...
import DetailedParams from '../pages/detailed/route.config'
...
export const toDetailedPage = (option?: ToRouterType<DetailedParams>) => {
  navigateType("/pages/detailed/index", option);
};

export const toStatisticsPage = (option?: ToRouterType<any>) => {
  navigateType("/pages/statistics/index", option);
};
